            ...
            CompositionLocalProvider(LocalLayoutDirection provides LayoutDirection.Rtl) {
                Column(
                    ...
                    Text(
                        ...
                        textAlign = TextAlign.Center,
                        color = Color(0xDAFFFFFF),
                        text = "متاسفانه پرداخت شما ناموفق بود و تراکنش به درستی انجام نشده است. در صورتی که از حساب شما مبلغ کسر شده طی ۷۲ ساعت آینده به حساب شما از طرف بانک عودت داده خواهد شد.\nدر صورتی که وجه به حساب شما عودت داده نشد از بانک عامل خود پیگیری فرمایید."
                    )
                    Spacer(modifier = Modifier.height(50.dp))
                    Button(onClick = {
                        Navigator.navigateTo(NavTarget.HomeScreen)
